...
const mobileCourses = [
  ...
  {
    title: "Flutter & Dart: Complete Mobile Mastery",
    category: "Mobile Development",
    duration: "55h 12m",
    lessons: 178,
    rating: 4.94,
  ...
  {
    title: "Android Kotlin & Jetpack Compose Modern",
    category: "Mobile Development",
    duration: "47h 45m",
    lessons: 164,
    rating: 4.93,
  ...
  {
    title: "Advanced React Native: State Management",
    category: "Mobile Development",
    duration: "38h 20m",
    lessons: 132,
    rating: 4.92,
  ...
  {
    title: "Cross-Platform Mobile Testing & CI/CD",
    category: "Mobile Development",
    duration: "29h 50m",
    lessons: 98,
    rating: 4.91,
  ...
  {
    title: "Mobile Performance Optimization Expert",
    category: "Mobile Development",
    duration: "34h 10m",
    lessons: 115,
    rating: 4.97,
  ...
  {
    title: "Native vs Cross-Platform: Architecture",
    category: "Mobile Development",
    duration: "26h 35m",
    lessons: 87,
    rating: 4.90,
  ...
  {
    title: "Mobile App Security & Privacy Best Practices",
    category: "Mobile Development",
    duration: "22h 45m",
    lessons: 76,
    rating: 4.94,
  ...
  {
    title: "Mobile UI/UX Design Patterns for Apps",
    category: "Mobile Development",
    duration: "31h 25m",
    lessons: 105,
    rating: 4.92,
...
export default function Mobile({ onNavigate, onRegisterClick }) {
  return (
    <>
      <style>{styles}</style>
      <div className="mobile-page">
        <div className="hero-section">
          <h1 className="hero-title">Featured Mobile App Development Courses</h1>
          <p className="hero-subtitle">
            Production-ready mobile skills for expert developers. Native, cross-platform, performance, and modern app architectures.
          </p>
        </div>
