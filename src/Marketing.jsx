...
function Marketing({ onNavigate }) {
  ...
  const courseData = [
    {
      title: "Digital Marketing Strategy 2024: Complete Masterclass",
    ...
    {
      title: "Google Ads & PPC Certification Course",
      category: "Google Ads",
      duration: "42h 45m",
      lessons: 128,
      rating: 4.7,
      students: "24.9K",
      image: "https://images.unsplash.com/photo-1558618047-3c8c76aaf229?w=800&q=90",
      instructor: {
        name: "David Wilson",
    ...
    {
      title: "Content Marketing & Copywriting Pro",
    ...
    <div style={{ backgroundColor: colors.darkBg, minHeight: '100vh', color: colors.textMain, fontFamily: "'Inter', sans-serif", padding: '20px 0' }}>
      ...
      <div style={{ textAlign: 'center', maxWidth: '1400px', margin: '40px auto 60px', padding: '0 20px' }}>
        ...
        <p style={{ fontSize: '1.3rem', color: colors.textMuted, maxWidth: '600px', margin: '0 auto' }}>
          Learn proven digital marketing strategies from top industry professionals.
        </p>
      </div>
