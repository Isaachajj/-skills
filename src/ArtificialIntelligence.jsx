...
function ArtificialIntelligence({ onNavigate }) {
  const colors = {
    accent: '#0ea5e9',
  ...
  const courseData = [
    {
      title: "Generative AI Mastery: GPT, Stable Diffusion & More",
      category: "Generative AI",
      duration: "56h 30m",
      lessons: 168,
      rating: 4.9,
      students: "45.2K",
      image: "https://images.unsplash.com/photo-1689366155076-98dc01188593?w=800&q=90",
      instructor: {
        name: "Dr. Aria Voss",
    ...
    {
      title: "Advanced Machine Learning with TensorFlow & PyTorch",
      category: "Deep Learning",
      duration: "62h 45m",
      lessons: 185,
      rating: 4.9,
      students: "38.9K",
      image: "https://images.unsplash.com/photo-1485827404703-89b55fcc59e8?w=800&q=90",
      instructor: {
        name: "Prof. Liam Chen",
    ...
    {
      title: "Computer Vision & OpenCV Masterclass",
      category: "Computer Vision",
      duration: "48h 20m",
      lessons: 142,
      rating: 4.8,
      students: "31.4K",
      image: "https://images.unsplash.com/photo-1632416476435-bff74fd6ab89?w=800&q=90",
      instructor: {
        name: "Dr. Sofia Patel",
    ...
    {
      title: "NLP with Transformers & BERT Models",
      category: "Natural Language Processing",
      duration: "51h 10m",
      lessons: 154,
      rating: 4.9,
      students: "29.7K",
      image: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?w=800&q=90",
      instructor: {
        name: "Marcus Lee",
    ...
    {
      title: "Reinforcement Learning: From Theory to Production",
      category: "Reinforcement Learning",
      duration: "55h 35m",
      lessons: 165,
      rating: 4.8,
      students: "24.6K",
      image: "https://images.unsplash.com/photo-1659058268806-c95a43a8e9b1?w=800&q=90",
      instructor: {
    ...
    },
    {
      ...
      rating: 4.7,
      students: "27.3K",
      image: "https://images.unsplash.com/photo-1700118327401-8f6ceae11e2b?w=800&q=90",
      instructor: {
        name: "James Novak",
    ...
    <div style={{ backgroundColor: colors.darkBg, minHeight: '100vh', color: colors.textMain, fontFamily: "'Inter', sans-serif", padding: '20px 0' }}>
      ...
      <div style={{ textAlign: 'center', maxWidth: '1400px', margin: '40px auto 60px', padding: '0 20px' }}>
        ...
        <p style={{ fontSize: '1.3rem', color: colors.textMuted, maxWidth: '600px', margin: '0 auto' }}>
          Learn cutting-edge AI from leading researchers and industry pioneers.
        </p>
      </div>
